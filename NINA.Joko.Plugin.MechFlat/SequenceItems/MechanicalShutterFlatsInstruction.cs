...
namespace NINA.Joko.Plugin.MechFlat.MechanicalShutterFlatsTestCategory {
    /// <summary>
    ...
    public class MechanicalShutterFlatsInstruction : SequenceItem {
        /// <summary>
        ...
        public MechanicalShutterFlatsInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public MechanicalShutterFlatsInstruction(MechanicalShutterFlatsInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new MechanicalShutterFlatsInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(MechanicalShutterFlatsInstruction)}, Text: {Text}";
        }
    }
}