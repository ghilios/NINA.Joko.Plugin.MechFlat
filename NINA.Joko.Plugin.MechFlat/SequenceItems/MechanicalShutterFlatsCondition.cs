...
namespace NINA.Joko.Plugin.MechFlat.MechanicalShutterFlatsTestCategory {
    ...
    public class MechanicalShutterFlatsCondition : SequenceCondition {
        /// <summary>
        ...
        public MechanicalShutterFlatsCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new MechanicalShutterFlatsCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(MechanicalShutterFlatsCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}