...
namespace NINA.Joko.Plugin.MechFlat.MechanicalShutterFlatsTestCategory {
    ...
    public class MechanicalShutterFlatsTrigger : SequenceTrigger {
        /// <summary>
        ...
        public MechanicalShutterFlatsTrigger() {
        }

        public override object Clone() {
            return new MechanicalShutterFlatsTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(MechanicalShutterFlatsTrigger)}";
        }
    }
}